    ...
    getDefaultMiddleware({
      serializableCheck: {
        ...
        ignoredActionPaths: [
          ...
          'payload.lastSubscriptionDate',
          'payload.subscription.startDate',
          'payload.subscription.endDate',
          'payload.subscription.trialEndsAt',
          'payload.subscription.lastPaymentDate',
          'payload.subscription.nextPaymentDate',
          'payload.permissionStatus.lastChecked',
          'meta.arg.examDate',
          'meta.arg.createdAt',
          'meta.arg.updatedAt'
        ],
        ignoredPaths: [
          ...
          'auth.user.lastSubscriptionDate',
          'auth.user.subscription.startDate',
          'auth.user.subscription.endDate',
          'auth.user.subscription.trialEndsAt',
          'auth.user.subscription.lastPaymentDate',
          'auth.user.subscription.nextPaymentDate',
          'auth.user.permissionStatus.lastChecked',
          'auth.users',
          'examResults.results',
